...
import com.demo.xiaobaicai.littledemo.adapter.LauncherPagerAdapter;
import com.demo.xiaobaicai.littledemo.view.ILauncherView;
...
public class LauncherActivity extends FragmentActivity implements ILauncherView {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i("xiaobaicai","Launcher create");
		viewpagerLauncher = (ViewPager) findViewById(R.id.viewpager_launcher);
		adapter = new LauncherPagerAdapter(LauncherActivity.this, this);
